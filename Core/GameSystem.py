...
class GameSystem(metaclass=Solide):
    ...
    def game_init(self):
        ...
        DataBase().set_position_paddles((self.__main_display.get_rect().left + 50,
                                         self.__main_display.get_rect().centery - DataBase().DISPLAY_HEIGHT), (0, 0))
        ...
        event_system = EventSystem({"paddle": self.__paddle_left, "ball": self.__ball, "map": self.__map}, self)
